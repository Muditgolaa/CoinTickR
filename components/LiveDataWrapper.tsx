...
const LiveDataWrapper = ({ children,coinId,poolId,coin,coinOHLCData,
} : LiveDataProps) => {
    const [liveInterval,setLiveInterval] = useState<'1s'|'1m'>('1s')
    const {trades,ohlcv,price} = useCoinGeckoWebSocket({coinId,poolId,symbol: coin.symbol,liveInterval})
